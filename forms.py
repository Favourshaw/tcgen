...
class PostForm(ModelForm):
    class Meta:
        ...
        fields = ['company_name', 'company_address', 'website_url', 'country', 'policy_effective_date', 'industry', 'Privacy', 'Advertisment', 'gdrp_wording']
        widgets = {
            'company_name': forms.TextInput(attrs={'class': 'input-wrapper'}),
